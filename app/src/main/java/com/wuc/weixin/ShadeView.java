...
public class ShadeView extends View {
    ...
    public ShadeView(Context context, AttributeSet attrs) {
        ...
        BitmapDrawable drawable = (BitmapDrawable) typedArray.getDrawable(R.styleable.ChangeColorIconWithText_icon);
        if (drawable != null) {
            iconBitmap = drawable.getBitmap();
        }
        iconBackgroundColor = typedArray.getColor(R.styleable.ChangeColorIconWithText_color, DEFAULT_ICON_BACKGROUND_COLOR);
        text = typedArray.getString(R.styleable.ChangeColorIconWithText_text);
        int textSize = (int) typedArray.getDimension(R.styleable.ChangeColorIconWithText_text_size,
